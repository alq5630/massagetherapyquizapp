...
async function emailResults() {
  ...
  try {
    // Formspree-compatible JSON submit
    ...
    if (resp.ok) {
      els.emailStatus.textContent = "Sent! Your instructor has received your results.";
    } else {
      els.emailStatus.textContent = "Email service returned an error. Try again or contact your instructor.";
    }
  } catch (e) {
